...
for v in test['Continuous']:
    plt.figure()
    plt.hist(train_df[v][np.isfinite(train_df[v])])

g = sns.FacetGrid(train_df[test['Continuous']][np.isfinite(train_df[test['Continuous']])], col='SalePrice')
